...
export default function BatchForm({ batch }: { batch: Batch }) {
    ...
    return (
        <div className="p-6 grid md:grid-cols-5 gap-6 items-end hover:bg-slate-800/30 transition group">
            ...
            <div>
                 <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Parcela 2x (Kz)</label>
                 <input 
                    type="number" 
