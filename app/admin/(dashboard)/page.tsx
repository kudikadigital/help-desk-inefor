    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Visão geral da turma de Fevereiro/2026
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="rounded-2xl bg-slate-900 border border-slate-800 p-6 hover:border-slate-700 transition group relative overflow-hidden">
          ...
          {stats.waiting > 0 && (
            <div className="absolute top-0 right-0 w-1.5 h-full bg-orange-500 shadow-[0_0_15px_rgba(249,115,22,0.5)]"></div>
          )}
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
        ...
        <div className="px-6 py-5 border-b border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-2 p-1 bg-slate-950 rounded-lg border border-slate-800">
            <button className="px-3 py-1.5 text-xs font-medium bg-slate-800 text-white rounded-md shadow-sm">
              Todos
            </button>

            <button className="px-3 py-1.5 text-xs font-medium text-slate-500 hover:text-white transition">
              Pendentes
            </button>
